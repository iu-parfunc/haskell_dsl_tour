...
data Body
  ...
  | Locals [UVar] [UVar] [UVar] [(UVar,FVar)] [(UVar,[Var])] Tail
...
instance PP Body where
  ...
  pp (Locals l l2 l3 l4 l5 t) = (ppSexp [fromByteString "locals",(ppSexp (map pp l)),(ppSexp [fromByteString "ulocals",(ppSexp (map pp l2)),(ppSexp [fromByteString "spills",(ppSexp (map pp l3)),(ppSexp [fromByteString "locate",(ppSexp (map (\(u,f) -> (ppSexp [(pp u),(pp f)])) l4)),(ppSexp [fromByteString "frame-conflict",(ppSexp (map (\(u,l) -> (ppSexp ((pp u) : (map pp l)))) l5)),(pp t)])])])])])
  ppp (Locate l t) = (pppSexp [text "locate",(pppSexp (map (\(u,l) -> (pppSexp [(ppp u),(ppp l)])) l)),(ppp t)])
  ppp (Locals l l2 l3 l4 l5 t) = (pppSexp [text "locals",(pppSexp (map ppp l)),(pppSexp [text "ulocals",(pppSexp (map ppp l2)),(pppSexp [text "spills",(pppSexp (map ppp l3)),(pppSexp [text "locate",(pppSexp (map (\(u,f) -> (pppSexp [(ppp u),(ppp f)])) l4)),(pppSexp [text "frame-conflict",(pppSexp (map (\(u,l) -> (pppSexp ((ppp u) : (map ppp l)))) l5)),(ppp t)])])])])])
