...
module FrameworkHs.GenGrammars.L08SanitizeBindings where
...
instance PP Expr where
  ...
  pp (Letrec l e) = (ppSexp [fromByteString "letrec",(ppSexp (map (\(u,l,e) -> (ppSexp [(pp u),(ppSexp [fromByteString "lambda",(ppSexp (map pp l)),(pp e)])])) l)),(pp e)])
  ...
  ppp (Letrec l e) = (pppSexp [text "letrec",(pppSexp (map (\(u,l,e) -> (pppSexp [(ppp u),(pppSexp [text "lambda",(pppSexp (map ppp l)),(ppp e)])])) l)),(ppp e)])
