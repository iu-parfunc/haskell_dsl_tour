...
module FrameworkHs.GenGrammars.L09UncoverFree where
...
data Expr
  ...
  | Quote Immediate
  | Let [(UVar,Expr)] Expr
  | Letrec [(UVar,[UVar],[UVar],Expr)] Expr
...
instance PP Expr where
  ...
  pp (Letrec l e) = (ppSexp [fromByteString "letrec",(ppSexp (map (\(u,l,l2,e) -> (ppSexp [(pp u),(ppSexp [fromByteString "lambda",(ppSexp (map pp l)),(ppSexp [fromByteString "free",(ppSexp (map pp l2)),(pp e)])])])) l)),(pp e)])
  ...
  ppp (Letrec l e) = (pppSexp [text "letrec",(pppSexp (map (\(u,l,l2,e) -> (pppSexp [(ppp u),(pppSexp [text "lambda",(pppSexp (map ppp l)),(pppSexp [text "free",(pppSexp (map ppp l2)),(ppp e)])])])) l)),(ppp e)])
