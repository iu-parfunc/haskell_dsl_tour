...
module FrameworkHs.GenGrammars.L19SpecifyRepresentation where
...
instance PP Prog where
  pp (Letrec l t) = (ppSexp [fromByteString "letrec",(ppSexp (map (\(l,l2,t) -> (ppSexp [(pp l),(ppSexp [fromByteString "lambda",(ppSexp (map pp l2)),(pp t)])])) l)),(pp t)])
  ppp (Letrec l t) = (pppSexp [text "letrec",(pppSexp (map (\(l,l2,t) -> (pppSexp [(ppp l),(pppSexp [text "lambda",(pppSexp (map ppp l2)),(ppp t)])])) l)),(ppp t)])
