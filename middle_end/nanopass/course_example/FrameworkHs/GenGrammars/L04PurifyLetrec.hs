...
module FrameworkHs.GenGrammars.L04PurifyLetrec where
...
instance PP Expr where
  ...
  pp (Letrec l b) = (ppSexp [fromByteString "letrec",(ppSexp (map (\(u,l) -> (ppSexp [(pp u),(pp l)])) l)),(pp b)])
  ...
  ppp (Letrec l b) = (pppSexp [text "letrec",(pppSexp (map (\(u,l) -> (pppSexp [(ppp u),(ppp l)])) l)),(ppp b)])
