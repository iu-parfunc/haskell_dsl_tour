...
;;   uncover-well-known         l-10 -> l-12
;;   optimize-free              l-12 -> l-13
;;   optimize-self-reference    l-13 -> l-10
...
(p423-grammars
 ...
 (l05-convert-assignments 
  ...
  (l12-uncover-well-known
     (%remove (Expr letrec))
     (%add
       (Expr
         (letrec ((Label (lambda (UVar *) (bind-free (UVar *) Expr))) *) (closures ((UVar Label UVar *) *) (well-known (UVar *) Expr)))
       )
     )
  )
